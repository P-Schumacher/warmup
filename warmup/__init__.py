...
register(
    id="torque_arm-v0", entry_point="warmup.envs:TorqueArmMuJoCo", max_episode_steps=500
)

register(
    id="humanreacher-v0", entry_point="warmup.envs:HumanReacher", max_episode_steps=500
)
